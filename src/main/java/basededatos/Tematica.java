...
public class Tematica implements Serializable {
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			basededatos.Seccion[] lSeccion_contiene_tematicass = seccion_contiene_tematicas.toArray();
			for(int i = 0; i < lSeccion_contiene_tematicass.length; i++) {
				lSeccion_contiene_tematicass[i].pertenece_a_seccion.remove(this);
			}
			basededatos.Noticia[] lContienes = contiene.toArray();
	...
	private java.util.Set this_getSet (int key) {
		if (key == basededatos.ORMConstants.KEY_TEMATICA_SECCION_CONTIENE_TEMATICAS) {
			return ORM_seccion_contiene_tematicas;
		}
		else if (key == basededatos.ORMConstants.KEY_TEMATICA_CONTIENE) {
			return ORM_contiene;
		}
	...
	@ManyToMany(mappedBy="ORM_pertenece_a_seccion", targetEntity=basededatos.Seccion.class)	
	...
	@Transient	
	public final basededatos.SeccionSetCollection seccion_contiene_tematicas = new basededatos.SeccionSetCollection(this, _ormAdapter, basededatos.ORMConstants.KEY_TEMATICA_SECCION_CONTIENE_TEMATICAS, basededatos.ORMConstants.KEY_SECCION_PERTENECE_A_SECCION, basededatos.ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	@Transient	
	public final basededatos.NoticiaSetCollection contiene = new basededatos.NoticiaSetCollection(this, _ormAdapter, basededatos.ORMConstants.KEY_TEMATICA_CONTIENE, basededatos.ORMConstants.KEY_NOTICIA_PERTENECE_A, basededatos.ORMConstants.KEY_MUL_MANY_TO_MANY);
