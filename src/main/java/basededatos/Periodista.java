...
public class Periodista extends basededatos.Identificado implements Serializable {
	...
	@OneToOne(mappedBy="crea", targetEntity=basededatos.Noticia.class, fetch=FetchType.LAZY)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyToOne(value=org.hibernate.annotations.LazyToOneOption.NO_PROXY)	
	private basededatos.Noticia es_creada;
	...
	public void setEs_creada(basededatos.Noticia value) {
		if (this.es_creada != value) {
			basededatos.Noticia les_creada = this.es_creada;
	...
	public basededatos.Noticia getEs_creada() {
		return es_creada;
	}
