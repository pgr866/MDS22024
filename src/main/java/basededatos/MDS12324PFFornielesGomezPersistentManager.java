...
public class MDS12324PFFornielesGomezPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Identificado.class);
		aMetadataSources.addAnnotatedClass(basededatos.Editor.class);
		aMetadataSources.addAnnotatedClass(basededatos.Periodista.class);
		aMetadataSources.addAnnotatedClass(basededatos.Usuario_suscrito.class);
	}
