...
public class Portada extends basededatos.Seccion implements Serializable {
	public Portada() {
	}
	...
	public static Portada loadPortadaByORMID(PersistentSession session, int id_seccion) throws PersistentException {
		try {
			return (Portada) session.load(basededatos.Portada.class, Integer.valueOf(id_seccion));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Portada getPortadaByORMID(PersistentSession session, int id_seccion) throws PersistentException {
		try {
			return (Portada) session.get(basededatos.Portada.class, Integer.valueOf(id_seccion));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Portada loadPortadaByORMID(PersistentSession session, int id_seccion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Portada) session.load(basededatos.Portada.class, Integer.valueOf(id_seccion), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Portada getPortadaByORMID(PersistentSession session, int id_seccion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Portada) session.get(basededatos.Portada.class, Integer.valueOf(id_seccion), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
