...
public class Listado_noticias_busqueda_Usuario_no_registrado_item extends VistaListadonoticiasbusquedausuarionoregistrado_item {
	...
	public Listado_noticias_busqueda_Usuario_no_registrado_item(Listado_noticias_busqueda_Usuario_no_registrado _listado_noticias_busqueda_Usuario_no_registrado) {
		super();
