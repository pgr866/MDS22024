...
public class Pagina_noticia_Editor extends Pagina_noticia_Identificado {
	...
	public Pagina_noticia_Editor(interfaz.Mostrar_valoracion_noticia _mostrar_valoracion_noticia,
		...
		super(_mostrar_valoracion_noticia, _listado_noticias_portada_Identificado,
				_listado_noticias_busqueda_Identificado, _mostrar_noticia_extendida, _seccion_comentarios_Identificado);
