...
public class TematicaCriteria extends AbstractORMCriteria {
	...
	public base_de_datos.SeccionCriteria createSeccion_contiene_tematicasCriteria() {
		return new base_de_datos.SeccionCriteria(createCriteria("ORM_seccion_contiene_tematicas"));
	}
	
	public base_de_datos.NoticiaCriteria createContieneCriteria() {
		return new base_de_datos.NoticiaCriteria(createCriteria("ORM_contiene"));
	}
