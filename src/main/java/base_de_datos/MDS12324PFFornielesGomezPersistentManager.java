...
public class MDS12324PFFornielesGomezPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS12324PFFornielesGomez";
	...
	private MDS12324PFFornielesGomezPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(base_de_datos.Seccion.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Portada.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Tematica.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Noticia.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Comentario.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Identificado.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Editor.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Periodista.class);
		aMetadataSources.addAnnotatedClass(base_de_datos.Usuario_suscrito.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS12324PFFornielesGomezPersistentManager();
		}
