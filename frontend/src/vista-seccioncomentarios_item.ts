...
<vaadin-vertical-layout style="width: 100%; height: 100%; flex-shrink: 0; justify-content: flex-start;">
 <vaadin-horizontal-layout theme="" style="flex-shrink: 0; width: 100%; justify-content: space-between;">
  ...
  <vaadin-vertical-layout style="width: 60%; flex-shrink: 0; height: 100%; justify-content: center;" id="Layoutnickusuario">
 ...
 <vaadin-horizontal-layout theme="" style="flex-shrink: 0; width: 100%; justify-content: space-between;">
  <vaadin-vertical-layout style="width: 75%; flex-shrink: 0; height: 100%; justify-content: flex-start;" id="Layoutcontenidocomentario">
