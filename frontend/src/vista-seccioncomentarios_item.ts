...
<vaadin-vertical-layout style="width: 100%; height: 100%; flex-shrink: 0; justify-content: flex-start;">
 <vaadin-horizontal-layout theme="" style="flex-shrink: 0; width: 100%; justify-content: space-between;">
  <vaadin-vertical-layout style="width: 15%; height: 100%;">
  ...
  <vaadin-vertical-layout style="width: 60%; flex-shrink: 0; height: 100%; justify-content: center;">
   <vaadin-text-field style="width: 100%; flex-shrink: 1;" readonly value="Nick" has-value></vaadin-text-field>
  </vaadin-vertical-layout>
  <vaadin-vertical-layout style="width: 15%; flex-shrink: 0; height: 100%; flex-direction: row; justify-content: space-between;">
   ...
   <vaadin-vertical-layout style="width: 40%; flex-shrink: 0; height: 100%; justify-content: center;">
    <vaadin-text-field style="width: 100%; flex-shrink: 1;" readonly value="N" has-value></vaadin-text-field>
   </vaadin-vertical-layout>
  </vaadin-vertical-layout>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout theme="" style="flex-shrink: 0; width: 100%; justify-content: space-between;">
  <vaadin-vertical-layout style="width: 75%; flex-shrink: 0; height: 100%; justify-content: flex-start;">
   <vaadin-text-area style="width: 100%;" readonly has-value value="Contenido del comentario"></vaadin-text-area>
  </vaadin-vertical-layout>
  <vaadin-vertical-layout style="width: 6%; flex-shrink: 0; align-self: flex-start;">
   <vaadin-button style="width: 100%; height: 100%; flex-shrink: 0; flex-grow: 0; align-self: center; background-color: #FFFFFF;">
  ...
  <vaadin-vertical-layout style="width: 15%; flex-shrink: 0; height: 100%; flex-direction: row; align-self: flex-start; justify-content: space-between;">
   <vaadin-vertical-layout style="width: 40%; flex-shrink: 0; align-self: flex-start;">
    <vaadin-button style="width: 100%; flex-shrink: 0; flex-grow: 0; align-self: center; background-color: #FFFFFF; height: 100%;">
     <img style="width: 100%; height: 100%;" src="https://cdn-icons-png.flaticon.com/512/126/126504.png">
    </vaadin-button>
   </vaadin-vertical-layout>
   <vaadin-vertical-layout style="width: 40%; flex-shrink: 0; height: 100%; align-self: flex-start;">
    <vaadin-text-field style="width: 100%; flex-shrink: 1;" readonly value="N" has-value></vaadin-text-field>
   </vaadin-vertical-layout>
  </vaadin-vertical-layout>
 </vaadin-horizontal-layout>
