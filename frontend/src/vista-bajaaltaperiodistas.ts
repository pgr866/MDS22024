...
<vaadin-vertical-layout style="width: 100%; height: 100%; justify-content: space-between;">
 <vaadin-vertical-layout id="Layoutdaraltaperiodista" style="width: 100%; height: 55%; justify-content: space-between;">
  ...
  <vaadin-horizontal-layout style="width: 58%; height: 10%; justify-content: space-between; align-self: center; flex-shrink: 0;">
   <label style="width: 20%; height: 100%; text-align: center; flex-shrink: 0; font-size: 120%;" id="Labelapellidosdaraltaperiodista1">Apellidos</label>
  ...
  <vaadin-horizontal-layout style="width: 30%; height: 10%; justify-content: space-between; flex-shrink: 0; align-self: center;">
   <vaadin-button style="width: 100%; height: 100%; flex-shrink: 0; align-self: center;">
     Dar de alta 
   </vaadin-button>
  </vaadin-horizontal-layout>
 ...
 <vaadin-vertical-layout style="width: 100%; height: 40%; flex-shrink: 0; justify-content: space-between;" id="Layoutdarbajaperiodista">
  ...
  <vaadin-horizontal-layout style="width: 100%; height: 70%; align-self: center; justify-content: center;">
   <vaadin-horizontal-layout style="width: 60%; height: 20%; justify-content: space-between; align-self: center; flex-shrink: 0;" id="Darbajaperiodista">
    <vista-buscarperiodista style="flex-shrink: 0; height: 100%; width: 60%;"></vista-buscarperiodista>
