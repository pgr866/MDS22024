...
<vaadin-vertical-layout style="width: 100%; height: 100%; align-items: center; padding-top: var(--lumo-space-m); padding-right: var(--lumo-space-m); padding-bottom: var(--lumo-space-m); padding-left: var(--lumo-space-m);">
 <vaadin-horizontal-layout id="Layoutregistrarse" style="width: 100%; height: 25%; flex-shrink: 0; justify-content: space-between;">
  <vaadin-button theme="icon" ; style="height: 100%; width: 20%; flex-shrink: 0; background-color: #FFFFFF;" id="Logoregistrarse">
   <img src="../../src/main/resources/META-INF/resources/images/logo.svg" width="" alt="logo" style="width: 100%; height: 100%;" id="Imagenlogoregistrarse">
  </vaadin-button>
  <label style="width: 70%; height: 100%; flex-shrink: 0; font-size: 500%;" id="Labelregistrarse">Registrarse</label>
 ...
 <vaadin-vertical-layout style="flex-shrink: 0; align-self: center; width: 50%; flex-grow: 0; justify-content: space-evenly; height: 75%;">
  <vaadin-vertical-layout style="width: 100%; flex-shrink: 0;">
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutemailregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelemailregistrarse">Email</label>
    <vaadin-text-field placeholder="Email" style="flex-shrink: 0; width: 80%;" id="Textfieldemailregistrarse"></vaadin-text-field>
   </vaadin-horizontal-layout>
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutnombreregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelnombreregistrarse">Nombre</label>
   ...
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutapellidosregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelapellidosregistrarse">Apellidos</label>
   ...
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutfechanacimientoregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelfechanacimientoregistrarse">Fecha Nacimiento</label>
   ...
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutapodoregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelapodoregistrarse">Apodo</label>
   ...
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutdniregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labeldniregistrarse">DNI</label>
   ...
   <vaadin-horizontal-layout style="width: 100%; flex-shrink: 0;" id="Layoutntarjetaregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelntarjetaregistrarse">Nº Tarjeta</label>
   ...
   <vaadin-horizontal-layout style="width: 100%;" id="Layoutcontrasenaregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelcontrasenaregistrarse">Contraseña</label>
   ...
   <vaadin-horizontal-layout style="width: 100%;" id="Layoutrepetircontrasenaregistrarse">
    <label style="width: 20%; flex-shrink: 0; align-self: center;" id="Labelrepetircontrasenaregistrarse">Repetir Contraseña</label>
