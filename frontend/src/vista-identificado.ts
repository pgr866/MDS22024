...
<vaadin-vertical-layout style="width: 100%; height: 100%; position: absolute;">
 ...
 <vaadin-vertical-layout style="width: 100%; flex-shrink: 0; flex-grow: 0; padding-top: var(--lumo-space-s); padding-bottom: var(--lumo-space-s); padding-right: var(--lumo-space-m); padding-left: var(--lumo-space-m);">
  <vaadin-vertical-layout style="width: 100%; flex-grow: 0; flex-shrink: 0; flex-direction: row; align-content: space-between; flex-wrap: wrap; position: relative;" id="Layoutnoticiasportadaidentificado"></vaadin-vertical-layout>
 </vaadin-vertical-layout>
</vaadin-vertical-layout>
`;
  }
