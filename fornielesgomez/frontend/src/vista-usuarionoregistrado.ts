...
<vaadin-vertical-layout style="width: 100%; height: 100%; padding-bottom: var(--lumo-space-s); position: absolute;">
 <vaadin-horizontal-layout class="header" style="background-color: #EBEBEB; width: 100%; flex-shrink: 0; padding-top: var(--lumo-space-s); padding-right: var(--lumo-space-m); padding-left: var(--lumo-space-m); padding-bottom: var(--lumo-space-s); flex-grow: 0; justify-content: space-between; height: 15%;">
  ...
  <vaadin-vertical-layout style="width: 12%; height: 100%; flex-shrink: 1; padding-top: var(--lumo-space-m); padding-bottom: var(--lumo-space-m); flex-grow: 0;">
   <vaadin-button style="width: 100%; height: 100%; flex-shrink: 1;">
    Iniciar sesion
   </vaadin-button>
  </vaadin-vertical-layout>
 ...
 <vaadin-horizontal-layout style="width: 100%; justify-content: space-between; flex-shrink: 0; flex-grow: 1; padding-top: var(--lumo-space-s);">
  <vaadin-vertical-layout style="width: 15%; flex-shrink: 0; flex-grow: 0;"></vaadin-vertical-layout>
  <vaadin-vertical-layout style="width: 70%; flex-grow: 0; flex-shrink: 0; flex-direction: row; align-content: space-between; flex-wrap: wrap;"></vaadin-vertical-layout>
  <vaadin-vertical-layout style="width: 15%; flex-shrink: 0;"></vaadin-vertical-layout>
 </vaadin-horizontal-layout>
</vaadin-vertical-layout>
`;
  }
